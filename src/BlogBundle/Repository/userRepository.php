...
class UserRepository {
  ...
  public function newUser($newUserNom,$newUserPrenom,$newUserPseudo, $newUserMdp, $newUserCreate) {
    $results = $this->_db->prepare("INSERT INTO `user`(`user_lname`, `user_fname`, `user_pseudo`, `user_password`, `user_created`) VALUES ('$newUserNom','$newUserPrenom','$newUserPseudo','$newUserMdp','$newUserCreate')");
    $results->execute();
  }
